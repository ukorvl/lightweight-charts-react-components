...
- Keep `lightweight-charts` version consistent across the library and sandboxes code in examples. If you need to update the `lightweight-charts` version, make sure to update it in both the library and the sandboxes to avoid compatibility issues.
