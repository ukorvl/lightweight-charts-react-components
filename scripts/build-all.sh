...
export VITE_LIGHTWEIGHT_CHARTS_REACT_COMPONENTS_VERSION=$(jq -r .version $LIB_PACKAGE_JSON)
echo "lighweight-charts-components-version: $VITE_LIGHTWEIGHT_CHARTS_REACT_COMPONENTS_VERSION"

export VITE_LIGHTWEIGHT_CHARTS_VERSION=$(jq -r '.dependencies["lightweight-charts"]'  $ROOT_PACKAGE_JSON)
