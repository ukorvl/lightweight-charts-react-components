...
const BasicCandlestickSeriesChart = () => {
  return (
    <Chart height={400} {...chartCommonSettings}>
      <CandlestickSeries data={mockCandlestickSeriesData} />
    </Chart>
  );
};

export { BasicCandlestickSeriesChart };

const mockCandlestickSeriesData: CandlestickData[] = [
